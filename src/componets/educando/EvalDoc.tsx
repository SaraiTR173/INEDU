...
import "./css/EvalDoc.css";
import { useIonRouter } from "@ionic/react"; // Para la redirección
import SuccessAlertUpdate from "../login/alertUpdate"; 
import successImage from "../login/img/updatePass.png";
...
export default function EvaluacionDocente() {
  ...
  const handleConfirm = () => {
        ...
        setTimeout(() => {
            ...
            router.push("/educando/inicio", "forward"); // Redirigir al login después de 2 segundos
        }, 2000);
    };
